...
class RewardsCfg:
    ...
    track_EE_pb = RewTerm(func=mdp.track_EE_pb, weight=20.0)#15
    track_EE_reference_exp = RewTerm(func=mdp.track_EE_reference_exp, weight=2, params={"std": math.sqrt(0.5), "init_value": 0.98})#1.5
